<?php /*a:3:{s:58:"F:\wyb\shopwm\app\admin\view\setting\system_group\edit.php";i:1569378565;s:44:"F:\wyb\shopwm\app\admin\view\public\head.php";i:1569378565;s:45:"F:\wyb\shopwm\app\admin\view\public\style.php";i:1569378565;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    mpFrame.start(function(Vue){
        new Vue({
            ...
            data:{
                formData:{
                    id: '<?php echo htmlentities($Groupinfo['id']); ?>',
                    name: '<?php echo htmlentities($Groupinfo['name']); ?>',
                    config_name: '<?php echo htmlentities($Groupinfo['config_name']); ?>',
                    typelist: <?php echo $Groupinfo['fields'];?>,
                    info:'<?php echo htmlentities($Groupinfo['info']); ?>'
                }
            },
            methods:{
                addType: function(){
                ...
                submit: function(){
                    $eb.axios.post("<?php echo htmlentities($save); ?>",this.formData).then((res)=>{
