...
<script src="/system/plug/vue/dist/vue.min.js"></script>
<style>
...
<script>
    ...
    window.$id = "<?php echo htmlentities($id); ?>";
    window.$author = "<?php echo htmlentities($author); ?>";
    console.log($list);
    var _vue = new Vue({
        el:'#app',
        data:{
