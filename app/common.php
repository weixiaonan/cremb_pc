...
define('HOME_SITE_URL',\think\facade\Request::domain(1));
define('UPLOAD_SITE_URL',\think\facade\Request::domain(1). '/upload');
define('ATTACH_COMMON',\think\facade\Request::domain(1). '/attach');
